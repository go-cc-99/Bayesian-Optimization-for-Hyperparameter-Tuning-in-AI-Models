...
def train_fn_wrapper(
    ...
    *,
    ...
    inputs_path: str = "./Inputs_ChiPsiPhi_Local_DC2.npy",
    labels_path: str = "./Inputs_ThetaPhi_DC2.npy",
...
def main():
    ...
    p.add_argument("--inputs_path", type=str, default="./Inputs_ChiPsiPhi_Local_DC2.npy")
    p.add_argument("--labels_path", type=str, default="./Inputs_ThetaPhi_DC2.npy")
    ...
    # 5D space, to select 10 points, the pool is expanded to 10*3=30
    S = [10, 3] 
